...
bad_part = """                    @media screen and (max-width:640px){
                      .about-banner-module{
                        background-image: url(hubfs/contact-back.png) !important;
    background-image:  url('hubfs/rowbtm1.png');"""

fixed_part = """                    @media screen and (max-width:640px){
                      .about-banner-module{
                        background-image: url(hubfs/contact-back.png) !important;
                      }
                    }
        ...
        <!-- Address & Google Map & Contact Form Section -->
